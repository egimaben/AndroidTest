...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_TWEETS + "("
    ...
    public Cursor search(String key,String column){
    	...
    	String query="SELECT * from "+TABLE_TWEETS+" where "+column+" like '%"+key+"%'";
    	Log.d("DB", "search query="+query);
    	SQLiteDatabase db = this.getReadableDatabase();
    	
    	Cursor cursor = db.query(TABLE_TWEETS, new String[] {}, column + " like ?",
...
//        db.insert(TABLE_TWEETS, null, values);
		try {
			db.insertWithOnConflict(TABLE_TWEETS, null, values,
...
//         cursor.close();
    ...
    public void deleteAll(){
    	String query="DELETE FROM "+TABLE_TWEETS;
        SQLiteDatabase db = this.getWritableDatabase();
